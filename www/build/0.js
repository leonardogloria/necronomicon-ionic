...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__item_detail__ = __webpack_require__(479);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_chart_js__ = __webpack_require__(480);
...
var ItemDetailPage = /** @class */ (function () {
    function ItemDetailPage(navCtrl, navParams, items, _http) {
    ...
    ItemDetailPage.prototype.ionViewDidLoad = function () {
        ...
        this._http.get("http://localhost:8080/verify/1/1").subscribe(function (data) {
            _this.presences = data['ammount'];
            console.log(_this.presences);
            _this.doughnutChartMethod(_this.amount, _this.presences);
        });
    };
    ItemDetailPage.prototype.doughnutChartMethod = function (amount, presences) {
    ...
    ], ItemDetailPage.prototype, "doughnutCanvas", void 0);
 ...
 */
(function (global, factory) {
 true ? module.exports = factory(function() { try { return __webpack_require__(345); } catch(e) { } }()) :
